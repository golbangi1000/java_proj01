...
public class Read_Array_Data {
	public static void main(String[] args) {
		/*
		 * arr1.length : - 배열 방의 열의 갯수를 출력
		 * 		-1차원 배열 일떄 - 배열 방의 열의 갯수를 출력
		...
		//3. 2차월 배열에서 이중 For문을 사용해서 값을 넣기
		
		int[][] arr3 = new int[][] {{1,2,3}, {4,5,6}};
		
		
		for( int i =0; i < arr3.length; i++) {	//i 행의 방번호 arr2.length 
			//행의 정보를 출력
			for(int j = 0; j < arr3[i].length; j++) { // j: 열의 방번호 arr2[i].length 열의 갯수 
				//열의 정보를 출력
